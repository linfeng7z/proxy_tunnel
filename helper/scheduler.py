...
def runScheduler():
    ...
    scheduler.add_job(__runProxyFetch, 'interval', seconds=50, id="proxy_fetch", name="proxy采集")
    scheduler.add_job(__runProxyCheck, 'interval', seconds=30, id="proxy_check", name="proxy检查")
    executors = {
